...
2. Different measures were created as needed for the project so that you can create one according to your needs.
   ...
   ```
## Toggle 
A new table with prow values was added to create a toggle method loss. The column is ‘and ‘values as column data.
#Visualization
## Page1
...
2. Total profit, total orders,s and total returns for the month and year are chosen, and the goal in this visual indicates if the sales for this month are met or not based on age   
